...
translate([-35/2-4,-1,2]) cube([8,15,25]);
    ...
    // Filament ptfe guide cutout
        ...
        // PTFE tube slot 
        translate([-35/2,-23,15])rotate([-90,0,0]) cylinder(r=(4.3-0.1)/2, h=25, $fn=50);     // Main hole
...
difference(){
 ...
 module extruder_mount_holes(){
    ...
    translate([35/2-12,6.5,12.5+0.2-1])cylinder(r=1.65, h=14.3-0.2, $fn=30); // Top hole
    translate([35/2-12,6.5,27-1])cylinder(r=3.1, h=5, $fn=30); // Head cut
